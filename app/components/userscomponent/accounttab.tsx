...
const AccountTabs = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:space-x-4 m-4">
      <div className="w-full lg:w-1/4 bg-blue-300 dark:bg-slate-800 dark:shadow-white p-4 rounded-lg shadow">
        <div className="flex flex-col items-center">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="h-12 w-12 text-gray-700 mb-2 dark:text-white"
          >
            <path
              strokeLinecap="round"
          ...
          <p className="text-sm dark:text-white text-gray-500 text-center mb-4">
