...
//   const propertiesUnderPayment = users?.flatMap((user) =>
//     user.propertyUnderPayment.map((property) => ({
//       propertyId: property.propertyId,
//       userEmail: property.userEmail,
//       propertyType: property.propertyType,
//       propertyPrice: property.paymentHisotry[0]?.propertyPrice,
//       remainingBalance: property.paymentHisotry[0]?.remainingBalance,
//       userName: user.name,
//     }))
//   );
...
//       <h1 className="text-2x1 sm:text-4xl font-bold m-4 p-4">
...
//           : true) &&
//         (filter.price
//           ? property.propertyPrice.toString().includes(filter.price)
//           : true) &&
//         (filter.remainingBalance
//           ? property.remainingBalance
//               .toString()
//               .includes(filter.remainingBalance)
//           : true) &&
//         (filter.propertyType
